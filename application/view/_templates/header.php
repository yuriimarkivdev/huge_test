...
<body>
    ...
    <div class="wrapper">
        ...
        <ul class="navigation">
            ...
            <li <?php if (View::checkForActiveController($filename, "bulk_upload")) { echo ' class="active" '; } ?> >
                <a href="<?php echo Config::get('URL'); ?>bulk_upload/index">Bulk upload</a>
            </li><li <?php if (View::checkForActiveController($filename, "bulk_upload")) { echo ' class="active" '; } ?> >
                <a href="<?php echo Config::get('URL'); ?>bulk_upload/view">View Bulk uploads</a>
            </li>
