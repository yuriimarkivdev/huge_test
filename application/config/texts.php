...
return array(
    ...
    "FILE_NOT_LOADED" => "You have to load the file.",
    "NOT_CSV_FILE" => "File should have csv extension.",
    "WRONG_CSV_FILE_STRUCTURE" => "Wrong csv file structure.",
    "SOMETHING_BAD" => "Something bad happened.",
    "NO_UPLOADS" => "There is no uploads yet.",
);
